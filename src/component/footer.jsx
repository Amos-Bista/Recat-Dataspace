...
const Footer = () => {
  ...
  return (
    <div className=" bg-[#0D5077]  ">
          ...
          <div className=" flex w-[55%]">
            <div className="px-5 w-[70%] pr-5">
              ...
              <p className="pt-3 leading-relaxed text-justify text-1xl">
                we are Nepal First Data Center And Your Complete Technology
                Partner, Offering A Wide Range Of Services To Enhance Your
                Digital Journey.
              </p>
            </div>
      ...
      <div className="mx-16">
        <div className="flex justify-between border-t-2  border-b-2 border-[#E5E7EB] px- py-2 text-white">
