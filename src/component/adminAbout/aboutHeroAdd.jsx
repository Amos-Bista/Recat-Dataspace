...
const AboutHeroAdd = () => {
  ...
  const [aboutBgImage, setAboutBgImage] = useState(null); // Updated to null initially
  ...
  const handleTitleChange = (e) => setAboutName(e.target.value);
  const handleDescriptionChange = (e) => setAboutDescription(e.target.value);
  const handleImageChange = (event) => {
    setAboutBgImage(event.target.files[0]);
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formData.append("title", aboutName);
