...
import replicationaccordion from "../../../assests/accordionJson/replicationaccordion.json";

function ReplicationAccordion() {
  ...
  return (
    <div className="custom-accordion"  style={{ width: "100%", maxWidth: "700px", marginLeft: "-20px"}}>
      ...
      `}</style>
      {replicationaccordion.map((panel) => (
        <Accordion
          key={panel.id}
...
export default ReplicationAccordion;
