...
const BareHerosection = () => {
  const [currentSlide, setCurrentSlide] = useState(0);
  const slides = [
    {
      image: "/hero1.png",
      caption: "Bare Metal Server Service"
    },
    {
      image: "/bg2.jpeg",
      caption: "Bare Metal Server Service"
    ...
    <main className="flex justify-between w-[max-content] relative">
      <div className="relative">
        ...
        <div className="absolute top-[50%] left-[3%]">
          ...
          Experience Unrivaled Performance with Dataspace Bare Metal Server Solutions.
          </h2>
          <ButtonHerosection />
        </div>
      </div>
...
export default BareHerosection;
